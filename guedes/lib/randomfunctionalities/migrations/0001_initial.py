...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Microformat'
        db.create_table('randomfunctionalities_microformat', (
            ...
            ('thumb', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ...
        db.send_create_signal('randomfunctionalities', ['Microformat'])

        # Adding model 'Network'
        db.create_table('randomfunctionalities_network', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('color', self.gf(u'colorful.fields.RGBColorField')()),
        ...
        db.send_create_signal('randomfunctionalities', ['Network'])


    def backwards(self, orm):
        # Deleting model 'Microformat'
        db.delete_table('randomfunctionalities_microformat')

        # Deleting model 'Network'
        db.delete_table('randomfunctionalities_network')
