...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Microformat.country'
        db.delete_column('randomfunctionalities_microformat', 'country')


    def backwards(self, orm):
        # Adding field 'Microformat.country'
        db.add_column('randomfunctionalities_microformat', 'country',
                      self.gf('django.db.models.fields.CharField')(default='Portugal', max_length=50),
                      keep_default=False)
