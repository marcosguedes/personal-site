...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Microformat.last_update'
        db.alter_column('randomfunctionalities_microformat', 'last_update', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Microformat.last_update'
        db.alter_column('randomfunctionalities_microformat', 'last_update', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 4, 16, 0, 0)))
