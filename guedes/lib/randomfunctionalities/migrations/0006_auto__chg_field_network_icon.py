...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Network.icon'
        db.alter_column('randomfunctionalities_network', 'icon', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Network.icon'
        db.alter_column('randomfunctionalities_network', 'icon', self.gf('django.db.models.fields.CharField')(max_length=2))
