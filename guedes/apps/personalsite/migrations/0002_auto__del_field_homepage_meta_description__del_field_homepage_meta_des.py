...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomePage.meta_description'
        db.delete_column('personalsite_homepage', 'meta_description')

        # Deleting field 'HomePage.meta_description_en'
        db.delete_column('personalsite_homepage', 'meta_description_en')

        # Deleting field 'HomePage.meta_description_pt'
        db.delete_column('personalsite_homepage', 'meta_description_pt')


    def backwards(self, orm):
        # Adding field 'HomePage.meta_description'
        db.add_column('personalsite_homepage', 'meta_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.meta_description_en'
        db.add_column('personalsite_homepage', 'meta_description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomePage.meta_description_pt'
        db.add_column('personalsite_homepage', 'meta_description_pt',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)
