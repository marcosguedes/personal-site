...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Interest.slug'
        db.add_column('aboutme_interest', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Interest.slug'
        db.delete_column('aboutme_interest', 'slug')
    ...
    models = {
        ...
        'aboutme.interest': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['aboutme.Category']"}),
